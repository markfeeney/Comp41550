...
//        UIAlertView *message = [[UIAlertView alloc] initWithTitle:@"Expression is not valid"
//                                                          message:@"Ensure Expression has at least one variable"
//                                                         delegate:nil
...
//    }
    ...
    [self performSegueWithIdentifier:@"GraphViewSegue" sender:sender];
